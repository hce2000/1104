...
class CookieStep2_3 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cookie_step23)

        val nextPageBtn = findViewById<View>(R.id.button) as Button
        nextPageBtn.setOnClickListener{
            val intent = Intent()
            intent.setClass(this@CookieStep2_3, MainActivity_ZZZero::class.java)
        ...
        nextPageBtn3.setOnClickListener{
            val intent = Intent()
            intent.setClass(this@CookieStep2_3, TeatherAndStudent::class.java)
            startActivity(intent)
        }
        ...
        itemBtn.setOnClickListener{
            val intent = Intent()
            intent.setClass(this@CookieStep2_3, BreadStep3_0::class.java)
            startActivity(intent)
        }
        //聲音在這裡
        var voice = findViewById<ImageButton>(R.id.imageButton)
        var sp = SoundPool(10, AudioManager.STREAM_SYSTEM, 5)
        var music = sp.load(this, R.raw.pineapplebread8, 1)
